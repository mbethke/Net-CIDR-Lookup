...
A consequence of the same design is also that a /0 block can't be formed.
...
This module's methods are based even more loosely than those of C<Net::CIDR::Lookup> on those of C<Net::CIDR::Lite>
